...
- **Documentation site** (Starlight, `docs/`, GitHub Pages) covers BOTH the Java/Kotlin and the Python (pasgarde) libraries: an API change in either lib needs a docs update here.
